...
<body>
  ...
  <div style="padding: 6px 16px; background: ${
    ...
    <p style="font-size: 10px; color: ${
      ...
      يمكن التحقق من صحة الاتصال عبر نظام إدارة الأعمال، دون الحاجة إلى معلومات الاتصال الخاصة بشركة twsai من خلال التحقق من البيانات عبر البريد الإلكتروني أو الرسائل القصيرة.
    </p>
  </div>
  `
      : ""
